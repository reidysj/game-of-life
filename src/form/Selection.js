...
const Selection = ({ isRunning, setGridSize, setCount, setViewingArray, setIsRunning }) => {
  ...
  return (
    <>
      <Text>Grid Size</Text>
      <Select name="gridSize" onChange={e => handleChange(e, setGridSize, setCount, setViewingArray)} textAlign="center">
